...
END IF;
    ...
    IF NOT EXISTS (SELECT FROM pg_tables WHERE tablename = 'inventory_reservations') THEN
...
END IF;
    ...
    IF EXISTS (SELECT FROM pg_tables WHERE tablename = 'inventory_reservations') THEN
